...
public class RevenueController {
    ...
    public RevenueResponse getRevenue(
            @Parameter(description = "Data no formato ISO-8601 (yyyy-MM-dd)", example = "2026-03-21", schema = @Schema(type = "string", format = "date")) @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate date,
