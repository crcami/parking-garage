...
class RevenueControllerTest {
    ...
    /** Verifies that an invalid date format returns HTTP 400 with a descriptive message. */
    @Test
    ...
    /** Verifies that a valid date returns HTTP 200 with the revenue payload. */
    @Test
    void getRevenue_shouldReturn200ForValidDate() throws Exception {
    ...
    /** Verifies that a missing sector parameter returns HTTP 400. */
    @Test
